...
export interface IMUSDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IMUSD extends BaseContract {
  connect(runner?: ContractRunner | null): IMUSD;
  waitForDeployment(): Promise<this>;

  interface: IMUSDInterface;
