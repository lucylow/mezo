...
export interface ITigrisRouterInterface extends Interface {
  getFunction(
...
export interface ITigrisRouter extends BaseContract {
  connect(runner?: ContractRunner | null): ITigrisRouter;
  waitForDeployment(): Promise<this>;

  interface: ITigrisRouterInterface;
