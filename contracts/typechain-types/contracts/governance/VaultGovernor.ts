...
export interface VaultGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    functionFragment: "updateQuorumAmount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export namespace QuorumAmountUpdatedEvent {
...
export interface VaultGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): VaultGovernor;
  waitForDeployment(): Promise<this>;

  interface: VaultGovernorInterface;
  ...
  quorum: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;

  quorumAmount: TypedContractMethod<[], [bigint], "view">;
  ...
  updateQuorumAmount: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "updateQuorumAmount"
  ...
  >;
  getEvent(
    key: "QuorumAmountUpdated"
  ): TypedContractEvent<
    QuorumAmountUpdatedEvent.InputTuple,
    QuorumAmountUpdatedEvent.OutputTuple,
    QuorumAmountUpdatedEvent.OutputObject
  >;
  getEvent(
    key: "TimelockChange"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "QuorumAmountUpdated(uint256,uint256)": TypedContractEvent<
      QuorumAmountUpdatedEvent.InputTuple,
      QuorumAmountUpdatedEvent.OutputTuple,
      QuorumAmountUpdatedEvent.OutputObject
    >;
    QuorumAmountUpdated: TypedContractEvent<
      QuorumAmountUpdatedEvent.InputTuple,
      QuorumAmountUpdatedEvent.OutputTuple,
      QuorumAmountUpdatedEvent.OutputObject
    >;
