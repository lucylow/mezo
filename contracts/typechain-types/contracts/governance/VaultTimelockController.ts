...
export interface VaultTimelockControllerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface VaultTimelockController extends BaseContract {
  connect(runner?: ContractRunner | null): VaultTimelockController;
  waitForDeployment(): Promise<this>;

  interface: VaultTimelockControllerInterface;
